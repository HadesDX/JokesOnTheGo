...
public class Settings extends PreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || HostsPreferenceFragment.class.getName().equals(fragmentName)
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class HostsPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_hosts);
            setHasOptionsMenu(true);
            bindPreferenceSummaryToValueHash(findPreference("selected_hosts"));
        }
